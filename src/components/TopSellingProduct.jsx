    ...
    return (
        <div className="py-12 bg-gray-50">
            <div className="container mx-auto text-center">
                <h2 className="text-3xl font-semibold text-gray-800 mb-8">Top Selling Products</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    ...
                    <div className="border rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <h3 className="text-xl font-semibold text-gray-800">Sports Shoes</h3>
                            <p className="text-gray-600">Durable and comfortable for any sport</p>
                    ...
                    <div className="border rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <h3 className="text-xl font-semibold text-gray-800">Cricket Bat</h3>
                            <p className="text-gray-600">High-performance bat for pros</p>
                            <div className="mt-4 flex justify-between items-center">
                    ...
                    <div className="border rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <h3 className="text-xl font-semibold text-gray-800">Football Kit</h3>
                            <p className="text-gray-600">Complete set for every football player</p>
                            <div className="mt-4 flex justify-between items-center">
                    ...
                    <div className="border rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <h3 className="text-xl font-semibold text-gray-800">Tennis Racket</h3>
                            <p className="text-gray-600">Precision and power for serious players</p>
                            <div className="mt-4 flex justify-between items-center">
